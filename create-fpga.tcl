...
#
# Generated by Vivado on Fri Sep 22 16:41:41 +0200 2023
...
#
#    "D:/Xilinx/projects/pynq_z2_led_switcher/fpga/fpga.srcs/sources_1/new/top.v"
#    "D:/Xilinx/projects/pynq_z2_led_switcher/fpga/fpga.srcs/constrs_1/new/constraints.xdc"
#    "D:/Xilinx/projects/pynq_z2_led_switcher/fpga/fpga.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/fpga.srcs/sources_1/new/top.v"]"\
 "[file normalize "$origin_dir/fpga.srcs/constrs_1/new/constraints.xdc"]"\
 "[file normalize "$origin_dir/fpga.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
 "[file normalize "$origin_dir/pynq-z2-board/A.0/board.xml"]"\
  ]
  foreach ifile $files {
...
set file "[file normalize "$origin_dir/fpga.srcs/constrs_1/new/constraints.xdc"]"
...
if { [get_files top.v] == "" } {
  import_files -quiet -fileset sources_1 D:/Xilinx/projects/pynq_z2_led_switcher/fpga/fpga.srcs/sources_1/new/top.v
}
...
\
  ...
  connect_bd_net -net switch_0_0_1 [get_bd_ports switch_0] [get_bd_pins top_0/switch_0]
  connect_bd_net -net switch_1_0_1 [get_bd_ports switch_1] [get_bd_pins top_0/switch_1]
  connect_bd_net -net top_0_led [get_bd_pins top_0/led] [get_bd_ports led]
  connect_bd_net -net top_0_led_0 [get_bd_pins top_0/led_0] [get_bd_ports led_0]
  connect_bd_net -net top_0_led_1 [get_bd_pins top_0/led_1] [get_bd_ports led_1]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-414,-142",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 2 -x 420 -y 60 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 2 -x 420 -y 90 -defaultsOSRD
preplace port port-id_led_0 -pg 1 -lvl 2 -x 420 -y 270 -defaultsOSRD
preplace port port-id_led_1 -pg 1 -lvl 2 -x 420 -y 300 -defaultsOSRD
preplace port port-id_switch_0 -pg 1 -lvl 0 -x 0 -y 270 -defaultsOSRD
preplace port port-id_switch_1 -pg 1 -lvl 0 -x 0 -y 300 -defaultsOSRD
preplace portBus btn -pg 1 -lvl 0 -x 0 -y 330 -defaultsOSRD
preplace portBus led -pg 1 -lvl 2 -x 420 -y 330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 210 -y 110 -defaultsOSRD
preplace inst top_0 -pg 1 -lvl 1 -x 210 -y 300 -defaultsOSRD
preplace netloc btn_0_1 1 0 1 20J 320n
preplace netloc processing_system7_0_FCLK_CLK0 1 0 2 30 220 390
preplace netloc switch_0_0_1 1 0 1 20J 270n
preplace netloc switch_1_0_1 1 0 1 NJ 300
preplace netloc top_0_led 1 1 1 390J 320n
preplace netloc top_0_led_0 1 1 1 390J 270n
preplace netloc top_0_led_1 1 1 1 NJ 300
preplace netloc processing_system7_0_DDR 1 1 1 NJ 60
preplace netloc processing_system7_0_FIXED_IO 1 1 1 390J 80n
levelinfo -pg 1 0 210 420
pagesize -pg 1 -db -bbox -sgen -110 0 530 380
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/fpga.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/fpga.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
